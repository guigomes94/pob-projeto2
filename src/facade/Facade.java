...
public class Facade {
	...
	public static Loan saveOrUpdateLoan(Long id, LocalDate loanDate, User user, Book book, LocalDate devolutionDate)
			throws Exception {
		DAO.begin();
	...
	public static Loan searchLoanById(Long id) {
	...
	public static Reservation saveOrUpdateReservation(Long id, LocalDate reservationDate, User user, Book book)
			throws Exception {
		DAO.begin();
	...
	public static void removeReservation(Long id) throws Exception {
		DAO.begin();
		Reservation result = daoReservation.read(id);
		if (result == null) {
			DAO.rollback();
	...
	public static Reservation searchReservationById(Long id) {
